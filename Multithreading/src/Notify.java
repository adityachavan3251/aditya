...
{  
    ...
    {  
        synchronized(this)  
        {  
            System.out.println("1)The Starting of " + Thread.currentThread().getName());  
            try {  
                this.wait();  
            }  
...
class Notify2 extends Thread {  
    ...
    {  
        ...
        {  
            System.out.println(" 2) Starting of " + Thread.currentThread().getName());  
            try {  
                this.notify1.wait();  
            }  
            catch (InterruptedException e) {  
...
{  
    ...
    {  
        synchronized(this.notify1)  
        {  
            System.out.println(" 3) Starting of " + Thread.currentThread().getName());  
